...
def run_preprocess(input_path):
    ...
    # Add Brain Metastases Segmentation
    # HD-BM-slim (needs T1C and FLAIR)
    # https://github.com/NeuroAI-HD/HD-BM

    # def mr_tumor_segmentation(in_dir_path, out_dir_path):
    #     """
    #     Perform HD-BM slim segmentation for complete folder with the following structure:
    #     t1_km: PATIENT_IDENTIFIER_0000.nii.gz
    #     flair: PATIENT_IDENTIFIER_0001.nii.gz
    #     :param in_dir_path: str or pathlike object |
    #     :param out_dir_path: str or pathlike object |
    #     :return: tumor segmentation
    #     """
    #     cmd = f'hd_bm_slim_predict_folder -i {in_dir_path} -o {out_dir_path}'
    #     os.system(cmd)